...
<div class="relative bg-white overflow-hidden container mx-auto  mb-20 z-0">
        ...
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              ...
              <Link to='/products'><p className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">Shop Now</p></Link> 
            </div>
  ...
  <div class="w-11/12 mx-auto lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
