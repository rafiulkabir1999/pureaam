...
function CreateReview() {
    return ( 
     ...
     <div className='flex flex-col items-center justify-center md:justify-between  md:flex-row pt-24 '>
    <div className="flex flex-col  w-11/12 mr-0 md:mr-2 md:1/2  md:w-full md:mx-0"> 
    <input type="text" className='p-2 outline-0 bg-gray-200' placeholder='Input your Order ID' /> 
    <textarea rows="5" cols="10" className='p-2 outline-0' /> <input type="submit" className='bg-green-400 w-full p-2 outline-0 hover:bg-green-500 text-white cursor-pointer' /> </div>
    
    
    
    <div className="p-2 w-11/12 p-8 m-0 mx-atuo bg-white flex items-center justify-evenly  m-0 flex-col md:flex-row mt-1 md:w-full ">
